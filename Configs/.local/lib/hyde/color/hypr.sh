...
[[ -z "${__CURSOR_SIZE}" ]] && __CURSOR_SIZE=$(get_hyprConf "CURSOR_SIZE")
[[ -z "${__FONT}" ]] && __FONT=$(get_hyprConf "FONT")
[[ -z "${__FONT_SIZE}" ]] && __FONT_SIZE=$(get_hyprConf "FONT_SIZE")
[[ -z "${__DOCUMENT_FONT}" ]] && __DOCUMENT_FONT=$(get_hyprConf "DOCUMENT_FONT")
[[ -z "${__DOCUMENT_FONT_SIZE}" ]] && __DOCUMENT_FONT_SIZE=$(get_hyprConf "DOCUMENT_FONT_SIZE")
[[ -z "${__MONOSPACE_FONT}" ]] && __MONOSPACE_FONT=$(get_hyprConf "MONOSPACE_FONT")
[[ -z "${__MONOSPACE_FONT_SIZE}" ]] && __MONOSPACE_FONT_SIZE=$(get_hyprConf "MONOSPACE_FONT_SIZE")
